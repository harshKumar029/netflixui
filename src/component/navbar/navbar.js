...
import SearchBar from '../2page/search/search';
import './navbar.css';
...
const Navbar = () => {
  ...
  const navbarStyle = {
    backgroundColor: scrollPosition > 20 ? 'rgb(20 20 20 / 82%)' : 'transparent',
    transition: 'all ease 600ms', // Transition effect
  };
    return (
        <>
        <div className='bg'style={navbarStyle}>
                <div className='header-cont container'>
                    <div className='left-cont'>
                        <img className="header-brand"
